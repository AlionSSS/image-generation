...
class GeneratorNet(BasicModule):
    ...
    def __init__(self, ngf, nz):
        ...
        self.cnn_block1 = cnn_block(nz, ngf * 8, 4, 1, 0)  # (ngf*8) x 4 x 4
        self.cnn_block2 = cnn_block(ngf * 8, ngf * 4, 4, 2, 1)  # (ngf*4) x 8 x 8
        self.cnn_block3 = cnn_block(ngf * 4, ngf * 2, 4, 2, 1)  # (ngf*2) x 16 x 16
        self.cnn_block4 = cnn_block(ngf * 2, ngf, 4, 2, 1)  # (ngf) x 32 x 32
        self.cnn_block5 = nn.Sequential(nn.ConvTranspose2d(ngf, 3, 5, 3, 1, bias=False), nn.Tanh())  # 3 x 96 x 96
